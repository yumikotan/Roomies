...
exports.buildProfile = (answers = {}, rankings = {}) => {
  ...
  const I_Clean = exports.clamp(
    exports.roundToHalf(0.7 * a(4) + 0.3 * a(5)) +
    getRankBoost(rankings, "cleanliness"),
    1, 5
  );
  ...
  const I_Noise = exports.clamp(
    exports.roundToHalf(0.7 * a(10) + 0.3 * a(11)) +
    getRankBoost(rankings, "noise"),
    1, 5
  );
  ...
  const I_Sleep = exports.clamp(
    exports.roundToHalf(0.6 * a(13) + 0.4 * a(14)) +
    getRankBoost(rankings, "sleep"),
    1, 5
  );
...
exports.computeMatch = (pA, pB) => {
  ...
  return {
    ...
    factors: {
      cleanliness: cleanSim,
      noise: noiseSim,
      sleep_schedule: sleepSim
    }
  };
};
