...
import { collection, addDoc, Timestamp } from "https://www.gstatic.com/firebasejs/10.13.2/firebase-firestore.js";
...
export async function createChore(householdId, choreData) {
  try {
    ...
    const newChore = {
      ...
      custom_rotation_days: choreData.custom_rotation_days || null,
    };
